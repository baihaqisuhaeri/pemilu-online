...
<head>
    ...
    <title>Pemungutan Suara Online - Pilih Presiden</title>
...
<body class="min-h-screen" style="background: linear-gradient(135deg, #f8fafc 0%, #fee2e2 100%);">
    ...
    <div class="bg-red-700 text-white py-4 px-8 flex justify-between items-center shadow-lg">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-red-200 text-xs">Pemilihan Presiden & Wakil Presiden</p>
            </div>
        </div>
    ...
    <div class="text-center py-10 px-4">
        <h2 class="text-3xl font-extrabold text-gray-800 mb-2">Pilih Presiden & Wakil Presiden</h2>
    ...
    <img src="{{ asset('images/header_presiden.jpg') }}" alt="Header DPR" class="w-full object-contain mt-5 mb-5">

    <form method="POST" action="{{ route('voting.presiden.store') }}">
        @csrf
                        ...
                        <div class="p-5">
                            <div class="flex justify-around text-center mb-3">
                                <div class="w-1/2 pr-2">
                                    <p class="text-xs text-gray-400 mb-1 uppercase tracking-wide">Calon Presiden</p>
                                    <p class="font-extrabold text-gray-800 text-xl leading-tight">{{ $candidate->name }}</p>
                                </div>
                                <div class="border-l border-gray-200"></div>
                                <div class="w-1/2 pl-2">
                                    <p class="text-xs text-gray-400 mb-1 uppercase tracking-wide">Calon Wakil Presiden</p>
                                    <p class="font-extrabold text-gray-800 text-xl leading-tight">{{ $candidate->wakil_name }}</p>
                                </div>
                            </div>
                            <p class="text-sm text-gray-500 leading-relaxed text-center border-t border-gray-100 pt-3">
                                {{ $candidate->visi_misi ?? 'Visi misi belum tersedia.' }}
                            </p>
                        </div>
